...
const restaurant = async (userInfo: RestaurantData) => {
  try {
    ...
    console.log('Error from suggestion ', err);  // Log any errors that occur during fetch
    return Promise.reject('Could not complete suggestion form.');  // Return a rejected promise with an error message
  }
}
...
export { login, signup, restaurant };  // Export the login function to be used elsewhere in the application
